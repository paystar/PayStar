...
//        print("electrictuyhuik minLength \(String(describing: elMinL))")
//        
//        
...
//        let textFieldValue: String = searchTextField.text ?? ""
//        let billerID: String = KeychainWrapper.standard.string(forKey: "billerId") ?? ""
